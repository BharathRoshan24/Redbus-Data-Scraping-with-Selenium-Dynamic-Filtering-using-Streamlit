...
Python 3.9.I MySQL 8.0 Streamlit Selenium

FEATURES OF APPLICATION Retrive the Bus Information:
...
pandas as pd mysql.connector import time streamlit as slt import datetime from streamlit_option_menu import option_menu from selenium import webdriver image
